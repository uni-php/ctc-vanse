...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getData({id:dictCode}).then(response => {
        this.form.dictType = response.data.dict_type;
        this.form.dictCode=response.data.id
        this.form.dictLabel=response.data.dict_label
        this.form.dictValue=response.data.dict_value
        this.form.dictSort=response.data.dict_sort
