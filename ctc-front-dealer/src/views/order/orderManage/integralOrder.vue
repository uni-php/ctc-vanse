...
<template>
  <div class="app-container">
    <div class="tab-bar">
        <el-form ref="queryForm" :model="queryForm" label-width="100px" :inline="true" size="small">
          <el-form-item label="订单号" prop="order">
              <el-input style="width:260px" v-model="queryForm.order" placeholder="请输入订单号"></el-input>
          </el-form-item>
          <el-form-item label="会员昵称" prop="nickname">
              <el-input style="width:260px" v-model="queryForm.nickname" placeholder="请输入会员昵称"></el-input>
          </el-form-item>
    ...
    <el-table
        ...
        <el-table-column prop="nickname" align="center" label="会员昵称"></el-table-column>
        ...
        <el-table-column prop="money" align="center" label="礼品金额"></el-table-column>
        <el-table-column prop="points_num" align="center" label="礼品积分"></el-table-column>
        <el-table-column prop="gift_num" align="center" label="兑换数量"></el-table-column>
        ...
        <el-table-column label="操作" align="center" fixed="right" width="260px">
         <template slot-scope="scope" v-if="scope.row.children">
              ...
              <!-- <el-button
                    ...
                    type="text"
                    v-if="scope.row.status==0"
                    @click="handleEdit(scope.row)">修改发货地址</el-button> -->
         </template>
        </el-table-column>
    </el-table>
     <pagination
    ...
    <el-dialog title="标记发货" :visible.sync="sendOpen" width="30%" @close="sendOpen=false">
      <el-form :model="sendForm" ref="sendForm" label-width="100px" :rules="sendRule" size="medium">
        <el-form-item label="收货地址：" prop="address">
          <span>{{address.address+address.location}}</span>
        </el-form-item>
...
<script>
import {getPointsOrderList,markShipment} from '@/api/order/orderManage/points'
  ...
  methods: {
    ...
    getList(){
      var params=Object.assign({},this.queryForm)
        ...
        getPointsOrderList(params).then(res=>{
