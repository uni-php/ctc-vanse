<template>
  <div class="app-container">
      ...
      <div v-if="activeName=='welcome'">
            <p>提示：欢迎页可选择开启，开启后导购员扫码会先看到此页面，2-5秒后自动转入活动页或扫码页，欢迎页可以用来做广告哦！</p>
      ...
      <div v-if="activeName=='activity'">
          <p>提示：活动页是导购员扫码后参与活动的页面，以活动主图为主，作为活动入口，清晰的设计很重要哦！</p>
          <el-row class="content-box">
                <el-col :span="12" style="height:100%">
                <!-- 手机盒子 -->
                    <div class="mobile-box">
      ...
      <div v-if="activeName=='propaganda'">
          <p>提示：宣传页是导购员参与活动后，或者无活动时看到的页面，可以设置丰富的内容哦！！</p>
          <el-row class="content-box">
...
import {saveScanTpl,getTplInfo} from '@/api/app/guide/activity'
export default {
    components:{
        ImgPanel,
        vuedraggable
    ...
    data(){
        return{
            ...
            acviveForm:{
                ...
                btn_text:'我知道了',
                is_fangwei:0,//是否开启防伪
                cover:'https://cdn.uni-2id.com/guide_active_page.png'
            },
            activeRule:{
...
.mobile-box{
    ...
    .app-body{
        ...
        .app-bar-box{
            position: relative;
            cursor: move;
            background-color: #ea523c !important;
            height: 64px;
            font-size: 16px;
            color: #fff;
            font-weight: bold;
