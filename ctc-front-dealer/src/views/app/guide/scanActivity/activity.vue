...
<script>
import {getActivityList,setActivityStatus,deleActivity,getActivityInfo} from '@/api/app/guide/activity'
...
export default {
    ...
    methods:{
        ...
        createActivity(){
            this.$router.push({path:'/guide/sacnaAtivity/addActivity'})
        },
        handleEdit(row){
            this.$router.push({path:'/guide/sacnaAtivity/addActivity',query:{activity_id:row.id}})
        },
        query(){
