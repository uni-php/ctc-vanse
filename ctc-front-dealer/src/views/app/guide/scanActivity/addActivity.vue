            ...
            <el-collapse v-model="activeNames" >
                <el-collapse-item title="高级策略" name="1">
                    <el-form :model="seniorForm" ref="seniorForm" label-width="140px" class="seniorForm" :rules="seniorRule" size="medium">
                        ...
                        <!-- 非导购员扫码 -->
                        <el-form-item prop="isnot_guide_tips" label="非导购员提示" >
                            <el-input style="width:50%"   v-model="seniorForm.isnot_guide_tips" placeholder="请输入非导购员扫码提示"/>
                            <!-- <el-link type="primary" @click="empty_tips">点击查看示例</el-link> -->
                        </el-form-item>
                        ...
                        <el-form-item prop="is_user_limit" label="指定导购员参与" >
                            <el-switch :active-value="1" :inactive-value="0" v-model="seniorForm.is_user_limit"></el-switch>
                        </el-form-item>
                        <el-form-item prop="guide_gruop" label="导购员分组" v-if="seniorForm.is_user_limit==1">
                          <el-select style="width:50%" multiple v-model="seniorForm.guide_gruop" placeholder="请选择分组">
                              <el-option
                        ...
                        <el-form-item prop="unexpected_user_tips" label="非指定导购员领奖提示" v-if="seniorForm.is_user_limit" >
                            <el-input style="width:50%"   v-model="seniorForm.unexpected_user_tips" placeholder="非指定导购员领奖提示"/>
                        </el-form-item>
...
import GuideTpl from '@/components/GuideTpl'
import RedPack from '@/components/RedPack'
import GiftPanel from '@/components/GiftPanel'
import  vuedraggable from "vuedraggable"
import { regionDataPlus,CodeToText, TextToCode } from 'element-china-area-data'
import {saveActivity,getActivityInfo} from '@/api/app/guide/activity'
    ...
    data(){
        return{
            ...
            seniorForm:{
                ...
                isnot_guide_tips:'哦噢，你不是导购员,不能参与活动',
                guide_gruop:[],
                is_join_limit:false,
