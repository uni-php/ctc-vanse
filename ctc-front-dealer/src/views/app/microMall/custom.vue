                                            ...
                                            <div class="product-box">
                                                <div class="product-item">
                                                    ...
                                                    <div class="product_info">
                                                        ...
                                                        <div class="product-sale">已销售{{item.product_sale}}</div>
...
import {saveMallTpl,getTplInfo} from '@/api/app/mall'
export default {
  components: { myMarquee,vuedraggable },
    data(){
        return{
            ...
            title:{
                page_title:'微商城',
                share_title:'微商城',
                share_text:'我正在看微商城，挺不错的，你也来看看吧。',
                share_img:'###'
            },
            a:'ss',
            tabPosition: 'left',
    ...
    methods:{
        ...
        add(item){
            ...
            if(item.type=='custom'){
                var status=this.page.filter(item=>item.type=='custom')
        ...
        deleteItem(index){
            var arr=Object.assign([],this.page)
            arr.splice(index,1)
            console.log(arr)
            this.$nextTick(()=>{
                this.page=arr
