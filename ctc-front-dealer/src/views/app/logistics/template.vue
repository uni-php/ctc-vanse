                ...
                <div class="app-content">
                                    ...
                                    <el-row>
                                        <el-col :span="4">
                                            <el-form-item prop="is_trace" label="" label-width="20px" >
                                                <el-checkbox @change="saveTab" v-model="tabForm.is_trace"  :true-label="1" :false-label="0">物流</el-checkbox>
                                            </el-form-item>
                                        </el-col>
                                        <el-col :span="14">
                    ...
                    <el-popover
                        ...
                        <div class="trace-info" :class="{'actives':active_index==4}" slot="reference" @click="traceInfoBox" v-show="activeTabName=='1'">
                            ...
                            <p>提示：物流信息将显示商品的入库、出库信息，请在相应模块中添加物流信息。</p>
                        </div>
                    </el-popover>
                    <!-- 认证信息 -->
                    <el-popover
...
import {saveTraceTpl,getTplInfo} from '@/api/app/logistics/template'
...
export default {
    ...
    data(){
        return{
            ...
            companyForm:{
                company_title:'企业信息',
                is_business_license_code:0,
                is_business_license_url:0,
                is_dealer_name:1,
                is_address:1,
                is_telephone:1,
                is_email:1,
    ...
    methods:{
        ...
        getTplInfo(){
            getTplInfo({}).then(res=>{
                ...
                //tab页
                this.tabForm={
                    is_trace:res.data.tab[1].is_show,
                    trace_name:res.data.tab[1].title,
                    is_product:res.data.tab[0].is_show,
                    product_name:res.data.tab[0].title,
                    is_company:res.data.tab[2].is_show,
                    company_name:res.data.tab[2].title
                }
                //数据表格全赋值无影响
        ...
        saveTab(){
            if(!this.tabForm.is_trace&&!this.tabForm.is_product&&!this.tabForm.is_company){
