			...
			<view class="order-item">
				<view class="order-list" v-if="orderInfo.pay_mode=='direct'">
					<view class="goods-item">
						<u--image :showLoading="true" :src="orderInfo.order_gift_info.cover.length>0?orderInfo.order_gift_info.cover[0].url:''" width="90px" height="90px"></u--image>
						<view class="recom-info">
							<u--text :lines="2" :text="orderInfo.order_gift_info.gift_name" size="13"></u--text>
							...
							<view class="recom-points">
								...
								<u--text v-if="orderInfo.order_gift_info.type==2" :text="'+￥'+orderInfo.order_gift_info.money" color="#ff9900" size="12"></u--text>
							</view>
				...
				<view class="order-list" v-else>
					<view class="goods-item" v-for="(it,idx) in orderInfo.order_gift_info">
