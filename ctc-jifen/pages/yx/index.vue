...
<script>
	...
	import {getAuthInfo,getOpenid,getJsConfig,getTpl,getPrize} from '@/api/app/qrcode/index.js'
	...
	export default{
		...
		onLoad({dealer_id,qrcode,batch}) {
			...
			if(uni.getSystemInfoSync().platform == 'ios'){
				console.log('fuck')
				this.url=`${location.origin}/?dealer_id=${dealer_id}&batch=${batch}&qrcode=${qrcode}`
			}else{
