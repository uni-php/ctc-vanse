<template>
  <div class="app-container">
    ...
    <!-- 审核码包 -->
    <el-dialog title="码包审核" :visible.sync="checkDialog" width="50%" @close="checkDialog=false">
        <el-form ref="checkForm" :model="checkForm" label-width="130px">
...
<script>
import {listWaitCode,deleCode,getRelProduct,checkCode,downLoad} from "@/api/code/index"
export default {
    data(){
        return{
            relProductData:[],
