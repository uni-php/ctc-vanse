                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="状态:" prop="status">
                                    <span>{{form.status==0?'未授权':form.status==1?'正常':"已禁用"}}</span>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                        ...
                        <el-row>
                            ...
                            <el-col :span="12">
                                <el-form-item label="营业期限:" prop="business_period">
                                    <span>{{form.business_period}}</span>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
            ...
            <div v-if="redName=='send'">
                ...
                <el-table
                    ...
                    style="width: 100%">
                     ...
                     <el-table-column prop="app_id" align="center" label="发放应用" :formatter="scene"></el-table-column>
                </el-table>
                <pagination
                    v-show="+total>10"
                    :total="+total"
