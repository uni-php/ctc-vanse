<template>
	<view class="container">
		<view class="top-bk">
			...
			<view class="pay-btn" v-if="orderInfo.status==-1">
				待支付
			</view>
			<view class="pay-btn" v-if="orderInfo.status==1">
				待收货
...
<script>
	...
	export default{
		...
		methods:{
			...
			getUserInfo(){
				return Api.getUserInfo({openid:this.openid,dealer_id:this.store_info.dealer_id}).then(res=>{
